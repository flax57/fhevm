...
CREATE INDEX IF NOT EXISTS idx_allowed_handles_is_computed ON allowed_handles(is_computed);
CREATE INDEX IF NOT EXISTS idx_allowed_handles_allowed_at ON allowed_handles(allowed_at);
